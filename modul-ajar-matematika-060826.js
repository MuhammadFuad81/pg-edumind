  ...
  *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:#0f172a;color:#0f172a;font-family:Inter,ui-sans-serif,system-ui,-apple-system,"Segoe UI",sans-serif;-webkit-user-select:none;user-select:none}
  ...
  <div id="loginScreen" class="login">
    <div class="login-card">
      ...
      <div class="eyebrow">Prompt Generator</div><h1>Modul Ajar Matematika</h1><p class="sub">Asisten Kerja Digital Sekolah V1</p>
      <form id="loginForm">
  ...
  <div id="appScreen" class="app hidden">
    <header class="topbar"><div class="brand"><div class="brand-icon"><i class="fa-solid fa-calculator"></i></div><div><h2>Modul Ajar Matematika</h2><p>Mengikuti Template Modul Ajar - Acuan</p></div></div><button id="logoutBtn" class="danger" type="button"><i class="fa-solid fa-right-from-bracket"></i> Keluar</button></header>
    <main class="layout">
      <section class="card"><div class="cardhead"><h3><i class="fa-solid fa-list-check"></i> Form Parameter Modul Ajar</h3><button id="exampleBtn" class="smallbtn" type="button"><i class="fa-solid fa-flask"></i> Muat Contoh</button></div>
        <form id="generatorForm" class="form-scroll" novalidate>
          ...
          <div class="field"><label>Mata Pelajaran <span class="req">*</span></label><select id="mapel" class="control" required></select><span class="hint">Matematika Tingkat Lanjut tersedia khusus Fase F Kelas XI dan XII.</span></div>
          ...
          <div class="field"><label>Lingkup Materi <span class="req">*</span></label><input id="lingkup" class="control" required placeholder="Contoh: Penjumlahan dan pengurangan bilangan cacah"></div>
          ...
          <div class="field"><label>Capaian Pembelajaran</label><textarea id="cp" class="control textarea cp" readonly aria-readonly="true"></textarea><span class="hint">Bersumber dari dokumen CP Matematika dan CP Matematika Tingkat Lanjut yang dilampirkan. Redaksi tidak dapat diedit.</span></div>
          ...
          <div class="field"><label>Pendekatan Pembelajaran <span class="req">*</span></label><select id="pendekatan" class="control" required><option selected>Pembelajaran Mendalam (Deep Learning), Berdiferensiasi</option><option>Pembelajaran Mendalam (Deep Learning)</option><option>Pembelajaran Berdiferensiasi</option><option>Matematika Realistik (PMRI/RME)</option><option>Kontekstual (Contextual Teaching and Learning/CTL)</option><option>TaRL (Teaching at the Right Level)</option><option value="Lainnya">Lainnya</option></select><input id="pendekatan_lain" class="control other-field hidden" placeholder="Tuliskan pendekatan pembelajaran lainnya"></div>
          <div class="field"><label>Model Pembelajaran <span class="req">*</span></label><select id="model" class="control" required><option selected>Problem Based Learning (PBL)</option><option>Project Based Learning (PjBL)</option><option>Discovery Learning</option><option>Inquiry Learning</option><option>Cooperative Learning</option><option>Direct Instruction</option><option>Realistic Mathematics Education (RME)</option><option value="Lainnya">Lainnya</option></select><input id="model_lain" class="control other-field hidden" placeholder="Tuliskan model pembelajaran lainnya"></div>
          <div class="field"><span class="label">Metode Pembelajaran <span class="req">*</span></span><div class="checks">
            ...
            <label><input type="checkbox" name="metode" value="Demonstrasi &amp; Praktik" checked>Demonstrasi &amp; Praktik</label><label><input type="checkbox" name="metode" value="Eksplorasi Benda Konkret">Eksplorasi Benda Konkret</label>
            <label><input type="checkbox" name="metode" value="Latihan Terbimbing">Latihan Terbimbing</label><label><input type="checkbox" name="metode" value="Pemecahan Masalah">Pemecahan Masalah</label>
          ...
          <div class="field"><label>Media &amp; Sumber Belajar (Sarana Prasarana) <span class="req">*</span></label><textarea id="media_sumber" class="control textarea" required placeholder="Contoh: Buku teks Matematika, benda konkret/manipulatif, kartu bilangan, garis bilangan, papan tulis, proyektor, LKPD, dan aplikasi matematika."></textarea></div>
  ...
  var CP_DATA = {
    "regular": {
      "A": {
        "label": "Fase A (Umumnya untuk Kelas I dan II SD/MI/Program Paket A)",
        "elements": [
          "Bilangan",
          "Aljabar",
          "Pengukuran",
        ...
        "text": "Pada akhir Fase A, murid memiliki kemampuan sebagai berikut.\n1.1. Bilangan: Menunjukkan pemahaman dan memiliki intuisi bilangan (number sense) pada bilangan cacah sampai 100; membaca, menulis, menentukan nilai tempat, membandingkan, mengurutkan, serta melakukan komposisi (menyusun) dan dekomposisi (mengurai) bilangan; melakukan operasi penjumlahan dan pengurangan menggunakan benda-benda konkret yang banyaknya sampai 20; dan menunjukkan pemahaman pecahan sebagai bagian dari keseluruhan melalui konteks membagi sebuah benda atau kumpulan benda sama banyak (pecahan yang diperkenalkan adalah setengah dan seperempat).\n1.2. Aljabar: Menunjukan pemahaman makna simbol matematika \"=\" dalam suatu kalimat matematika yang terkait dengan penjumlahan dan pengurangan bilangan cacah sampai 20 menggunakan gambar. Murid dapat mengenali, meniru, dan melanjutkan pola bukan bilangan (misalnya, gambar, warna, bunyi/suara).\n1.3. Pengukuran: Membandingkan panjang dan berat benda secara langsung, dan membandingkan durasi waktu; mengukur dan mengestimasi panjang dan berat benda menggunakan satuan tidak baku.\n1.4. Geometri: Mengenal berbagai bangun datar (segitiga, segiempat, segi banyak, lingkaran) dan bangun ruang (balok, kubus, kerucut, dan bola); melakukan komposisi (penyusunan) dan dekomposisi (penguraian) suatu bangun datar (segitiga, segiempat, dan segi banyak); dan menentukan posisi benda terhadap benda lain (kanan, kiri, depan belakang, bawah, atas).\n1.5. Analisis Data dan Peluang: Mengurutkan, menyortir, mengelompokkan, membandingkan, dan menyajikan data dari banyak benda dengan menggunakan turus dan piktogram paling banyak 4 kategori."
      },
      "B": {
        ...
        "text": "Pada akhir Fase B, murid memiliki kemampuan sebagai berikut.\n2.1. Bilangan: Memiliki pemahaman dan intuisi bilangan (number sense) pada bilangan cacah sampai 10.000; membaca, menulis, membandingkan, dan mengurutkan bilangan; menentukan dan menggunakan nilai tempat; melakukan komposisi dan dekomposisi bilangan cacah sampai 10.000. Murid dapat melakukan dan menyelesaikan masalah operasi bilangan penjumlahan dan pengurangan bilangan cacah sampai 1.000; melakukan dan menyelesaikan masalah operasi perkalian dan pembagian bilangan cacah sampai 100 dengan bantuan benda konkret, gambar dan simbol; mengenal kelipatan dan faktor. Murid dapat melakukan perbandingan dan pengurutan pecahan dengan pembilang satu dan antar pecahan dengan penyebut yang sama; mengenal dan dapat menerapkan pecahan senilai, memiliki intuisi pecahan dan desimal, serta dapat menentukan pecahan sebagai desimal dan persen.\n2.2. Aljabar: Menemukan nilai yang tidak diketahui dalam kalimat matematika yang melibatkan penjumlahan dan pengurangan pada bilangan cacah sampai 100, dengan menggunakan sifat-sifat bilangan dan operasinya. Murid dapat mengidentifikasi, meniru, dan mengembangkan pola gambar atau objek sederhana dan pola bilangan membesar dan mengecil yang dapat melibatkan penjumlahan dan pengurangan pada bilangan cacah sampai 100.\n2.3. Pengukuran: Mengukur panjang dan berat benda menggunakan satuan baku; menentukan hubungan antar-satuan baku panjang (cm, m) dan antar-satuan berat (g, kg); serta mengukur dan mengestimasi luas dan volume menggunakan satuan tidak baku dan satuan baku berupa bilangan cacah.\n2.4. Geometri: Mendeskripsikan ciri berbagai bentuk bangun datar (segiempat, segitiga, segi banyak); menyusun (komposisi) dan mengurai (dekomposisi) berbagai bangun datar dengan lebih dari satu cara jika memungkinkan.\n2.5. Analisis Data dan Peluang: Mengurutkan, membandingkan, menyajikan, menganalisis dan menginterpretasi data dalam bentuk tabel, diagram gambar, piktogram, dan diagram batang (skala satu satuan)."
      },
      "C": {
        ...
        "text": "Pada akhir Fase C, murid memiliki kemampuan sebagai berikut.\n3.1. Bilangan: Menunjukkan pemahaman dan intuisi bilangan (number sense) pada bilangan cacah sampai 1.000.000; membaca, menulis, menentukan nilai tempat, membandingkan, mengurutkan, melakukan komposisi dan dekomposisi bilangan; menyelesaikan masalah yang berkaitan dengan uang; melakukan operasi penjumlahan, pengurangan, perkalian, dan pembagian bilangan cacah sampai 100.000; serta menyelesaikan masalah yang berkaitan dengan KPK dan FPB. Murid dapat membandingkan dan mengurutkan berbagai pecahan termasuk pecahan campuran, melakukan operasi penjumlahan dan pengurangan pecahan, serta melakukan operasi perkalian dan pembagian pecahan dengan bilangan asli; mengubah pecahan menjadi berbagai bentuk pecahan lain, serta membandingkan dan mengurutkan bilangan desimal (satu angka di belakang koma).\n3.2. Aljabar: Menemukan nilai yang belum diketahui dalam kalimat matematika yang melibatkan penjumlahan, pengurangan, perkalian, dan pembagian pada bilangan cacah sampai 1000 dengan menggunakan sifat-sifat bilangan dan operasinya. Murid dapat mengidentifikasi, meniru, dan mengembangkan pola bilangan membesar dan mengecil yang melibatkan perkalian dan pembagian; bernalar secara proporsional untuk menyelesaikan masalah sehari-hari dengan rasio satuan; menggunakan operasi perkalian dan pembagian dalam menyelesaikan masalah sehari-hari yang terkait dengan proporsi.\n3.3. Pengukuran: Menentukan keliling dan luas berbagai bentuk bangun datar (segitiga, segiempat, dan segi banyak) serta gabungannya; menghitung durasi waktu dan mengukur besar sudut pada bangun datar atau yang dibentuk dari dua garis berpotongan.\n3.4. Geometri: Mengkonstruksi dan mengurai bangun ruang (kubus, balok, dan gabungannya) dan mengenali visualisasi spasial (bagian depan, atas, dan samping); membandingkan karakteristik antar bangun datar dan antar bangun ruang; serta menentukan lokasi pada peta yang menggunakan sistem berpetak.\n3.5. Analisis Data dan Peluang: Mengurutkan, membandingkan, menyajikan, dan menganalisis data banyak benda dan data hasil pengukuran dalam bentuk gambar, piktogram, diagram batang, dan tabel frekuensi untuk mendapatkan informasi; menentukan kejadian dengan kemungkinan yang lebih besar atau lebih kecil dalam suatu percobaan acak."
      },
      "D": {
  ...
  var example = {
    ...
    nama_penyusun:'Prabowo Subianto, S.Pd.Gr.', guru_kelas:'Guru Matematika Kelas II', institusi:'SD Islam Edumind Bekasi', tahun_ajaran:'2026/2027', alokasi:'2 JP (2 × 35 menit)', jenjang:'SD/MI', mapel:'Matematika', bab_ke:'BAB 2', semester:'I (Ganjil)', lingkup:'Penjumlahan dan pengurangan bilangan cacah sampai 20', target:'Peserta Didik Reguler/Tipikal', jumlah:'25 peserta didik',
    kompetensi_awal:'Peserta didik telah mengenal bilangan cacah sampai 20, mampu membilang dan membandingkan banyak benda, serta memiliki pengalaman dasar penjumlahan dan pengurangan sederhana sampai 10.',
    media_sumber:'Buku Siswa Matematika untuk SD/MI Kelas II, Bab 2 “Penjumlahan dan Pengurangan”; benda konkret seperti kelereng, kancing, atau lidi; kartu bilangan; garis bilangan; papan tulis; proyektor; dan LKPD soal cerita.',
    ...
    pustaka:'Dokumen Capaian Pembelajaran Matematika; buku teks Matematika yang digunakan satuan pendidikan; serta sumber kontekstual yang benar-benar digunakan guru. Lengkapi identitas bibliografi sesuai sumber nyata yang dipakai.', kepala:'Al Khawarizmi, S.Pd., M.Pd.Gr.', nip_kepala:'199005212009080005', nip_penyusun:'200107152025220007', format_output:'docx', tambahan:'Gunakan Bahasa Indonesia baku. Pastikan notasi, simbol, rumus, contoh, dan penyelesaian Matematika benar serta sesuai fase. Sajikan masalah kontekstual yang dekat dengan kehidupan peserta didik.'
  };
  ...
  function updateCP() {
    ...
    $('elemen_cp').value = item.label + '\n\n' + item.elements.map(function (x, i) { return (i + 1) + '. ' + x; }).join('\n');
    $('cp').value = item.text;
    $('cpNotice').innerHTML = '<strong>CP diisi otomatis dan dikunci.</strong> ' + item.label + '. Sumber: dokumen CP ' + (advanced ? 'Matematika Tingkat Lanjut' : 'Matematika') + ' yang dilampirkan.';
  }
  function updateDerived() {
    var cls = ($('fase_kelas').value.match(/Kelas\s+(\d+)/) || [,''])[1];
    if (cls && (!$('guru_kelas').value || /^Guru Matematika Kelas/.test($('guru_kelas').value))) $('guru_kelas').value = 'Guru Matematika Kelas ' + cls;
    updateMapelOptions();
    updateCP();
    syncTeacherName();
  }
  ...
  function setValues(data) {
    ...
    setOptions(data.fase_kelas || (data.jenjang === 'SD/MI' ? 'Fase A Kelas 2' : null));
  ...
  function generatePrompt() {
    ...
    var lines = [
      'PERAN',
      'Bertindaklah sebagai ahli desain instruksional, ahli Kurikulum Merdeka/Pembelajaran Mendalam, guru Matematika, dan editor dokumen Microsoft Word profesional.',
      '',
      'TUGAS UTAMA',
      ...
      'Kutip CP secara verbatim. Jangan meringkas, memarafrasekan, menambah, mengurangi, atau mengarang CP Matematika. Gunakan CP Matematika Tingkat Lanjut hanya ketika mata pelajaran tersebut dipilih pada Fase F.',
      '',
      'DESAIN PEMBELAJARAN',
      ...
      '6. Bahasa Indonesia harus baku dan operasional. Notasi, simbol, rumus, representasi, contoh, langkah penyelesaian, dan jawaban Matematika harus benar, konsisten, serta sesuai fase. Gunakan equation/format rumus Word yang terbaca dengan baik.',
  ...
  function downloadOutput() {
    var text = $('output').textContent;
    if (!text || text.indexOf('PERAN') !== 0) { $('formStatus').textContent = 'Hasilkan prompt terlebih dahulu.'; return; }
    var blob = new Blob(['\ufeff'+text],{type:'text/plain;charset=utf-8'}); var a=document.createElement('a'); a.href=URL.createObjectURL(blob); a.download='prompt-modul-ajar-matematika-060826.txt'; document.body.appendChild(a); a.click(); setTimeout(function(){URL.revokeObjectURL(a.href);a.remove();},0);
  }
  ...
  $('exampleBtn').addEventListener('click', function(){ setValues(Object.assign({fase_kelas:'Fase A Kelas 2'},example)); save(); $('output').textContent='Contoh Matematika Fase A Kelas II dimuat. CP terisi otomatis. Klik “Hasilkan Prompt” untuk membuat instruksi terbaru.'; $('cp').scrollIntoView({behavior:'smooth',block:'center'}); $('formStatus').textContent='Contoh Matematika Fase A Kelas II dimuat. CP terisi otomatis dan terkunci.'; });
  $('resetBtn').addEventListener('click', function(){ if(!confirm('Kosongkan konfigurasi tersimpan dan muat ulang contoh?'))return; localStorage.removeItem(STORAGE_KEY); setValues(Object.assign({fase_kelas:'Fase A Kelas 2'},example)); $('output').textContent='Formulir direset. CP terisi otomatis sesuai fase/kelas. Klik “Hasilkan Prompt” setelah data utama sesuai.'; $('formStatus').textContent='Formulir direset ke contoh Matematika Kelas II.'; });

  setOptions('Fase A Kelas 2');
  if (!restore()) setValues(Object.assign({fase_kelas:'Fase A Kelas 2'},example));
  refreshConditionalFields();
